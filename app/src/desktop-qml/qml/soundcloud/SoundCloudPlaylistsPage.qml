...
Page {
    ...
    TableView {
        ...
        itemDelegate: PlaylistDelegate {
            ...
            onDoubleClicked: pageStack.push({item: Qt.resolvedUrl("SoundCloudPlaylistPage.qml"), immediate: true})
        ...
        Keys.onReturnPressed: if (currentRow >= 0) pageStack.push({item: Qt.resolvedUrl("SoundCloudPlaylistPage.qml"), immediate: true})
