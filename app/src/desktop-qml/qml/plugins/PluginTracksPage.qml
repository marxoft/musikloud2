...
Page {
    ...
    TableView {
        ...
        Keys.onReturnPressed: if (currentRow >= 0) pageStack.push({item: Qt.resolvedUrl("PluginTrackPage.qml"), immediate: true})
    ...
    Menu {
        ...
        MenuItem {
            text: qsTr("View info")
            iconName: "help-info"
            onTriggered: pageStack.push({item: Qt.resolvedUrl("PluginTrackPage.qml"), immediate: true})
